...
from trainer import DiffusionTrainer, GANTrainer, ODETrainer, ScoreDistillationTrainer, PiFlowTrainer
...
def main():
    ...
    elif config.trainer == "piflow":
        trainer = PiFlowTrainer(config)
    else:
